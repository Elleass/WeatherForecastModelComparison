export const FORECAST_SERIES = [
  ...
  { key: 'precipType',       label: 'Precip Type',   color: '#663399', apiKey: 'precipitationType', axis: 'left' },
  ...
  { key: 'visibility',       label: 'Visibility',    color: '#ff9800', apiKey: 'visibility', axis: 'left', unit: 'km' },
